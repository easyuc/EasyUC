...
\newcommand{\supp}{\textrm{supp}} % support
...
\newcommand{\Adv}[1]{\hat{#1}} % For adversarially generated values
...
\begin{inparaenum}[(a)]
\item $(\Inv{\GrpEltU_1})^{\OrdW} = \GrpEltU_1$;
\item $(\Inv{\GrpEltU_2})^{\OrdW} = \GrpEltU_2$;
\item $(\Inv{\GrpEltE})^{\OrdW} = \GrpEltE$; and
\item $(\Inv{\GrpEltV})^{\OrdW} = \GrpEltV$.
\end{inparaenum}
